...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			input = element("input");
    			t0 = space();
    			t1 = text(/*isClicked*/ ctx[2]);
    			attr_dev(input, "placeholder", "이름을 입력하세요");
    			attr_dev(input, "class", "svelte-j03cgf");
    			add_location(input, file$2, 18, 2, 469);
    			set_style(section, "--width", /*width*/ ctx[1]);
    			set_style(section, "--height", /*height*/ ctx[0]);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(section, "click", /*click_handler*/ ctx[6], false, false, false),
    					action_destroyer(clickOutside_action = clickOutside.call(null, section, /*clickOutside_function*/ ctx[7]))
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*isClicked*/ 4) set_data_dev(t1, /*isClicked*/ ctx[2]);
    			...
    			if (clickOutside_action && is_function(clickOutside_action.update) && dirty & /*isClicked*/ 4) clickOutside_action.update.call(null, /*clickOutside_function*/ ctx[7]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => $$invalidate(2, isClicked = true);
    	const clickOutside_function = () => $$invalidate(2, isClicked = false);
    ...
    class PgSearch extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { height: 0, width: 1 });
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file$1, 8, 6, 167);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "svelte-1o6ay1u");
    			add_location(ul, file$1, 6, 2, 130);
    			attr_dev(div, "class", "wrapper svelte-1o6ay1u");
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ PgSearch, tabs });
    	return [tabs];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			p = element("p");
    			add_location(p, file, 11, 2, 191);
    			attr_dev(main, "class", "svelte-lt851x");
    			add_location(main, file, 9, 0, 169);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
