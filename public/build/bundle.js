...
var app = (function () {
    ...
    const file$3 = "src\\components\\SearchHistorys.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("즐겨찾기");
    			attr_dev(section0, "class", section0_class_value = "" + (null_to_empty(/*currentTab*/ ctx[2] === "최근검색" && "selected") + " svelte-qxxppo"));
    			add_location(section0, file$3, 8, 4, 231);
    			attr_dev(section1, "class", section1_class_value = "" + (null_to_empty(/*currentTab*/ ctx[2] === "즐겨찾기" && "selected") + " svelte-qxxppo"));
    			add_location(section1, file$3, 14, 4, 377);
    			attr_dev(div0, "class", "head svelte-qxxppo");
    			set_style(div0, "--h_height", /*headerHeight*/ ctx[1]);
    			add_location(div0, file$3, 7, 2, 173);
    			attr_dev(div1, "class", "wrapper svelte-qxxppo");
    			set_style(div1, "--height", /*height*/ ctx[0]);
    			add_location(div1, file$3, 6, 0, 122);
    		},
    		l: function claim(nodes) {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(section0, "click", /*click_handler*/ ctx[4], false, false, false),
    					listen_dev(section1, "click", /*click_handler_1*/ ctx[5], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*currentTab*/ 4 && section0_class_value !== (section0_class_value = "" + (null_to_empty(/*currentTab*/ ctx[2] === "최근검색" && "selected") + " svelte-qxxppo"))) {
    				attr_dev(section0, "class", section0_class_value);
    			}

    			if (dirty & /*currentTab*/ 4 && section1_class_value !== (section1_class_value = "" + (null_to_empty(/*currentTab*/ ctx[2] === "즐겨찾기" && "selected") + " svelte-qxxppo"))) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let currentTab = "최근검색";
    	const writable_props = ['width', 'height', 'headerHeight'];
    	...
    	$$self.$capture_state = () => ({ width, height, headerHeight, currentTab });
    	...
    	return [height, headerHeight, currentTab, width, click_handler, click_handler_1];
    }

    class SearchHistorys extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { width: 3, height: 0, headerHeight: 1 });
    		...
    		if (/*width*/ ctx[3] === undefined && !('width' in props)) {
    			console.warn("<SearchHistorys> was created without expected prop 'width'");
    		}
    ...
    const file$2 = "src\\components\\PgSearch.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*isClicked*/ ctx[4] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1shbk35");
    			add_location(input, file$2, 20, 2, 579);
    			set_style(section, "--width", /*width*/ ctx[3]);
    			set_style(section, "--c_height", /*container_height*/ ctx[2]);
    			attr_dev(section, "class", "svelte-1shbk35");
    			add_location(section, file$2, 15, 0, 418);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(section, "click", /*click_handler*/ ctx[7], false, false, false),
    					action_destroyer(clickOutside_action = clickOutside.call(null, section, /*clickOutside_function*/ ctx[8]))
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*container_height*/ 4) {
    				set_style(section, "--c_height", /*container_height*/ ctx[2]);
    			}
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let { container_height = "48px" } = $$props;
    	...
    	const writable_props = ['height', 'container_height', 'width', 'value'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<PgSearch> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('container_height' in $$props) $$invalidate(2, container_height = $$props.container_height);
    		if ('width' in $$props) $$invalidate(3, width = $$props.width);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$1, 12, 6, 394);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			p = element("p");
    			add_location(p, file, 11, 2, 201);
    			attr_dev(main, "class", "svelte-lt851x");
    			add_location(main, file, 9, 0, 177);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
